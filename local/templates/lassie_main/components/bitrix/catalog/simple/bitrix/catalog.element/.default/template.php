...
<div class="card product-page__card">
    <div class="card__top">
        <div class="card__photos gallery">
            ...
            <!--                <ul class="gallery__thumbnails">-->
            <!--                    <li class="gallery__thumbnails-item gallery__thumbnails-item_active">-->
            <!--                        <img src="http://lorempixel.com/570/525/animals/1" alt="доп картинка"-->
            <!--                             class="gallery__thumbnails-img">-->
            <!--                    </li>-->
            <!---->
            <!--                </ul>-->
            <!--            </div>-->
        ...
        <div class="card__info">
            <header class="card__info-header"><span class="flag flag_type_new">new</span>
                <h1 class="card__name">Шапка-бини для новорожденных Nokoset</h1>
                <div class="card__id text">518304-8490-036</div>
            </header>
            <div class="card__content-block">
                <div class="card__content-row">
                    <div class="card__price card__price_new">1199 р.</div>
                    <div class="card__price card__price_old">1499 р.</div>
                </div>
                <div class="card__discount text">Скидка: 20%</div>
            </div>
            <div class="card__content-block">
                <div class="card__subtitle text">Материал:</div>
                <div class="text">50% Шерсть</div>
                <div class="text">50% Акрил</div>
            </div>
                ...
                <div class="card__content-block">
                    ...
                    <div class="card__content-row card__content-row_checkboxes">
                        <div class="checkbox-tile checkbox-tile_size_extra">
                            <input id="card-size-1" name="Card[size]" type="radio" value="50" required
                                   class="checkbox-tile__elem">
                            <label for="card-size-1" class="checkbox-tile__label">50</label>
                        </div>
                        <div class="checkbox-tile checkbox-tile_size_extra">
                            <input id="card-size-2" name="Card[size]" type="radio" value="56" required
                                   class="checkbox-tile__elem">
                            <label for="card-size-2" class="checkbox-tile__label">56</label>
                        </div>
                        <div class="checkbox-tile checkbox-tile_size_extra">
                            <input id="card-size-3" name="Card[size]" type="radio" value="62" required
                                   class="checkbox-tile__elem">
                            <label for="card-size-3" class="checkbox-tile__label">62</label>
                        </div>
                        <div class="checkbox-tile checkbox-tile_size_extra">
                            <input id="card-size-4" name="Card[size]" type="radio" value="68" required
                                   class="checkbox-tile__elem">
                            <label for="card-size-4" class="checkbox-tile__label">68</label>
                        </div>
                        <div class="checkbox-tile checkbox-tile_size_extra">
                            <input id="card-size-5" name="Card[size]" type="radio" value="74" required
                                   class="checkbox-tile__elem">
                            <label for="card-size-5" class="checkbox-tile__label">74</label>
                        </div>
                        <div class="checkbox-tile checkbox-tile_size_extra">
                            <input id="card-size-6" name="Card[size]" type="radio" value="80" required
                                   class="checkbox-tile__elem">
                            <label for="card-size-6" class="checkbox-tile__label">80</label>
                        </div>
                        <div class="checkbox-tile checkbox-tile_size_extra">
                            <input id="card-size-7" name="Card[size]" type="radio" value="86" required
                                   class="checkbox-tile__elem">
                            <label for="card-size-7" class="checkbox-tile__label">86</label>
                        </div>
                        <div class="checkbox-tile checkbox-tile_size_extra">
                            <input id="card-size-8" name="Card[size]" type="radio" value="92" required
                                   class="checkbox-tile__elem">
                            <label for="card-size-8" class="checkbox-tile__label">92</label>
                        </div>
                        <div class="checkbox-tile checkbox-tile_size_extra">
                            <input id="card-size-9" name="Card[size]" type="radio" value="98" required
                                   class="checkbox-tile__elem">
                            <label for="card-size-9" class="checkbox-tile__label">98</label>
                        </div>
                        <div class="checkbox-tile checkbox-tile_size_extra">
                            <input id="card-size-10" name="Card[size]" type="radio" value="101" required
                                   class="checkbox-tile__elem">
                            <label for="card-size-10" class="checkbox-tile__label">101</label>
                        </div>
                    </div>
    ...
    <div class="card__tabs tabs">
        <ul class="tabs__nav">
            ...
            <li data-tab='4' class="tabs__nav-item"><a href="javascript:void(0);" class="tabs__nav-link">Отзывы
                    <span
                            class="card__reviews-num">74</span></a>
            </li>
        </ul>
        <div class="tabs__content-wrapper">
            <div data-tab='1' class="tabs__content tabs__content_active">
                ...
                <ul class="list list_markers">
                    <li class="list__item list__item_marker_orange text">Детская шапочка, теплая шерстяная вязка
                    </li>
                    <li class="list__item list__item_marker_orange text">Мягкая теплая подкладка из флиса</li>
                    <li class="list__item list__item_marker_orange text">Ветронепроницаемые вставки в области ушей
                    </li>
                    <li class="list__item list__item_marker_orange text">Сочетается в варежками “Nyytti” и пинетками
                        “Neuvo”
                    </li>
                </ul>
            </div>
            <div data-tab='2' class="tabs__content">
                <ul class="list list_markers">
                    <li class="list__item list__item_marker_orange text">90% шерсть</li>
                    <li class="list__item list__item_marker_orange text">10% слёзы китайских детей</li>
                </ul>
            </div>
            <div data-tab='3' class="tabs__content">
                <p class="text">Главное, не давайте носить ее вашему папе, а то она растянется и потеряет вид!</p>
            </div>
                ...
                <div class="reviews">
                    <div class="reviews__other">
                        <article class="review reviews__item">
                            <div class="raiting review__raiting"><span class="raiting__star">5 звезда</span><span
                                        ...
                                        class="raiting__star">3 звезды</span><span
                                        class="raiting__star">2 звезды</span><span
                                        class="raiting__star">1 звёзд</span>
                            </div>
                            <div class="review__message">
                                <p class="text">Отличная одежда для активного отдыха и игр на улице.</p>
                            </div>
                        ...
                        <article class="review reviews__item">
                            <div class="raiting review__raiting"><span class="raiting__star raiting__star_active">5 звезда</span><span
                                        class="raiting__star">4 звезды</span><span
                                        class="raiting__star">3 звезды</span><span
                                        class="raiting__star">2 звезды</span><span
                                        class="raiting__star">1 звёзд</span>
                            </div>
                            <div class="review__message">
                                <p class="text">Очень теплая и качественная одежда. Рекомендую!</p>
                            </div>
                            <footer class="review__footer">
                                <p>Добавил(а) Роберт,
                    ...
                    <div class="reviews__own">
                        <article class="review-form">
                            ...
                            <form method="post" action="" class="form js-form-validate">
                                <div class="form__row">
                                    ...
                                    <div class="form__col">
                                        <div class="raiting">
                                            <input id="raiting1-item5" name="Review[raiting]" type="radio" value="5"
                                                   required class="raiting__check">
                                            <label for="raiting1-item5" class="raiting__star raiting__star_choose">5
                                                звезда</label>
                                            <input id="raiting1-item4" name="Review[raiting]" type="radio" value="4"
                                                   required class="raiting__check">
                                            <label for="raiting1-item4" class="raiting__star raiting__star_choose">4
                                                звезды</label>
                                            <input id="raiting1-item3" name="Review[raiting]" type="radio" value="3"
                                                   required class="raiting__check">
                                            <label for="raiting1-item3" class="raiting__star raiting__star_choose">3
                                                звезды</label>
                                            <input id="raiting1-item2" name="Review[raiting]" type="radio" value="2"
                                                   required class="raiting__check">
                                            <label for="raiting1-item2" class="raiting__star raiting__star_choose">2
                                                звезды</label>
                                            <input id="raiting1-item1" name="Review[raiting]" type="radio" value="1"
                                                   required class="raiting__check">
                                            <label for="raiting1-item1" class="raiting__star raiting__star_choose">1
                                                звёзд</label>
                                        </div>
                                    </div>
                                </div>
                                <div class="form__row">
                                    ...
                                    <div class="form__col form__col_width_260">
                                        <input id="review-name" name="Review[name]" required class="input"
                                               type="text">
                                    </div>
                                </div>
                                <div class="form__row">
                                ...
                                <div class="form__row">
                                    ...
                                    <div class="form__col form__col_width_400">
                                        <textarea id="review-message" name="Review[message]" required
                                ...
                                <div class="form__row review-form__antispam-row">
                                    ...
                                    <div class="form__col form__col_width_130">
                                        <input id="review-spam" name="Review[spam]" required class="input"
                                               type="text"><a href="javascript:void(0);"
                                                              class="link review-form__refresh-captcha text">Обновить
                                            картинку</a>
                                    </div>
                                    <div class="form__col form__col_width_130">
                                ...
                                <div class="form__row review-form__btn-row">
                                    <div class="form__col form__col_width_280">
                                        <button type="submit" class="btn review-form__submit">Оставить отзыв
                                        </button>
                                    </div>
...
<article class="product-page__section">
    <h2 class="heading product-page__title"><span class="heading__text">С этим товаром покупают</span></h2>
    <ul class="goods product-page__goods">
        <li class="goods__item">
            <article class="good">
                <div class="good__content">
                    <a href="javascript:void(0);" class="good__link">
                        <img src="assets/images/good-1.jpg" alt="Товар" class="good__img" title=""><span
                                class="flag flag_type_new">new</span>
                    ...
                    <form method="post" action="" class="form good__order">
                        <div class="good__order-row">
                            ...
                            <div class="checkbox-tile">
                                <input id="good0-size0" name="Good[size]" type="radio" value="74" required
                                       class="checkbox-tile__elem">
                                <label for="good0-size0" class="checkbox-tile__label">74</label>
                            </div>
                            <div class="checkbox-tile">
                                <input id="good0-size1" name="Good[size]" type="radio" value="80" required
                                       class="checkbox-tile__elem">
                                <label for="good0-size1" class="checkbox-tile__label">80</label>
                            </div>
                            <div class="checkbox-tile">
                                <input id="good0-size2" name="Good[size]" type="radio" value="86" required
                                       class="checkbox-tile__elem">
                                <label for="good0-size2" class="checkbox-tile__label">86</label>
                            </div>
                            <div class="checkbox-tile">
                                <input id="good0-size3" name="Good[size]" type="radio" value="92" required
                                       class="checkbox-tile__elem">
                                <label for="good0-size3" class="checkbox-tile__label">92</label>
                            </div>
                            <div class="checkbox-tile">
                                <input id="good0-size4" name="Good[size]" type="radio" value="98" required
                                       class="checkbox-tile__elem">
                        ...
                        <div class="good__order-row">
                            ...
                            <div class="input-number">
                                <input id="good0-num" name="Good[number]" type="number" step="1" min="1" required
                                       class="input-number__elem">
                                <div class="input-number__counter"><span
                                            class="input-number__counter-spin input-number__counter-spin_more">Больше</span><span
                                            class="input-number__counter-spin input-number__counter-spin_less">Меньше</span>
        ...
        <li class="goods__item">
            <article class="good">
                <div class="good__content">
                    <a href="javascript:void(0);" class="good__link">
                        <img src="assets/images/good-2.jpg" alt="Товар" class="good__img" title=""><span
                                class="flag flag_type_sale">sale</span>
                    </a><a href="javascript:void(0);" class="like">Мне нравится</a>
                    <h4 class="good__name">Зимний комбинезон для новорожденных Grian</h4>
                    <div class="good__price-wrapper"><span class="good__price good__price_new">2 899 р.</span><span
                                class="good__price good__price_old">3 899 р.</span><span class="good__discount">Скидка 30%</span>
                    </div>
                </div>
                <div class="good__hover">
                    <form method="post" action="" class="form good__order">
                        <div class="good__order-row">
                            <label class="good__order-label">Выберите размер</label>
                            <div class="checkbox-tile">
                                <input id="good1-size0" name="Good[size]" type="radio" value="74" required
                                       class="checkbox-tile__elem">
                                <label for="good1-size0" class="checkbox-tile__label">74</label>
                            </div>
                            <div class="checkbox-tile">
                                <input id="good1-size1" name="Good[size]" type="radio" value="80" required
                                       class="checkbox-tile__elem">
                                <label for="good1-size1" class="checkbox-tile__label">80</label>
                            </div>
                            <div class="checkbox-tile">
                                <input id="good1-size2" name="Good[size]" type="radio" value="86" required disabled
                                       class="checkbox-tile__elem">
                                <label for="good1-size2" class="checkbox-tile__label">86</label>
                            </div>
                            <div class="checkbox-tile">
                                <input id="good1-size3" name="Good[size]" type="radio" value="92" required
                                       class="checkbox-tile__elem">
                                <label for="good1-size3" class="checkbox-tile__label">92</label>
                            </div>
                            <div class="checkbox-tile">
                                <input id="good1-size4" name="Good[size]" type="radio" value="98" required
                                       class="checkbox-tile__elem">
                        ...
                        <div class="good__order-row">
                            ...
                            <div class="input-number">
                                <input id="good1-num" name="Good[number]" type="number" step="1" min="1" required
                                       class="input-number__elem">
                                <div class="input-number__counter"><span
                                            class="input-number__counter-spin input-number__counter-spin_more">Больше</span><span
                                            class="input-number__counter-spin input-number__counter-spin_less">Меньше</span>
        ...
        <li class="goods__item">
            <article class="good">
                <div class="good__content">
                    <a href="javascript:void(0);" class="good__link">
                        <img src="assets/images/good-3.jpg" alt="Товар" class="good__img" title=""><span
                                class="flag flag_type_new">new</span>
                    </a><a href="javascript:void(0);" class="like">Мне нравится</a>
                ...
                <div class="good__hover">
                    <form method="post" action="" class="form good__order">
                        <div class="good__order-row">
                            <label class="good__order-label">Выберите размер</label>
                            <div class="checkbox-tile">
                                <input id="good2-size0" name="Good[size]" type="radio" value="74" required
                                       class="checkbox-tile__elem">
                                <label for="good2-size0" class="checkbox-tile__label">74</label>
                            </div>
                            <div class="checkbox-tile">
                                <input id="good2-size1" name="Good[size]" type="radio" value="80" required
                                       class="checkbox-tile__elem">
                                <label for="good2-size1" class="checkbox-tile__label">80</label>
                            </div>
                            <div class="checkbox-tile">
                                <input id="good2-size2" name="Good[size]" type="radio" value="86" required
                                       class="checkbox-tile__elem">
                                <label for="good2-size2" class="checkbox-tile__label">86</label>
                            </div>
                            <div class="checkbox-tile">
                                <input id="good2-size3" name="Good[size]" type="radio" value="92" required
                                       class="checkbox-tile__elem">
                                <label for="good2-size3" class="checkbox-tile__label">92</label>
                            </div>
                            <div class="checkbox-tile">
                                <input id="good2-size4" name="Good[size]" type="radio" value="98" required
                                       class="checkbox-tile__elem">
                        ...
                        <div class="good__order-row">
                            ...
                            <div class="input-number">
                                <input id="good2-num" name="Good[number]" type="number" step="1" min="1" required
                                       class="input-number__elem">
                                <div class="input-number__counter"><span
                                            class="input-number__counter-spin input-number__counter-spin_more">Больше</span><span
                                            class="input-number__counter-spin input-number__counter-spin_less">Меньше</span>
                ...
                <div class="good__hover">
                    <form method="post" action="" class="form good__order">
                        <div class="good__order-row">
                            <label class="good__order-label">Выберите размер</label>
                            <div class="checkbox-tile">
                                <input id="good3-size0" name="Good[size]" type="radio" value="74" required
                                       class="checkbox-tile__elem">
                                <label for="good3-size0" class="checkbox-tile__label">74</label>
                            </div>
                            <div class="checkbox-tile">
                                <input id="good3-size1" name="Good[size]" type="radio" value="80" required
                                       class="checkbox-tile__elem">
                                <label for="good3-size1" class="checkbox-tile__label">80</label>
                            </div>
                            <div class="checkbox-tile">
                                <input id="good3-size2" name="Good[size]" type="radio" value="86" required
                                       class="checkbox-tile__elem">
                                <label for="good3-size2" class="checkbox-tile__label">86</label>
                            </div>
                            <div class="checkbox-tile">
                                <input id="good3-size3" name="Good[size]" type="radio" value="92" required disabled
                                       class="checkbox-tile__elem">
                                <label for="good3-size3" class="checkbox-tile__label">92</label>
                            </div>
                            <div class="checkbox-tile">
                                <input id="good3-size4" name="Good[size]" type="radio" value="98" required
                                       class="checkbox-tile__elem">
                        ...
                        <div class="good__order-row">
                            ...
                            <div class="input-number">
                                <input id="good3-num" name="Good[number]" type="number" step="1" min="1" required
                                       class="input-number__elem">
                                <div class="input-number__counter"><span
                                            class="input-number__counter-spin input-number__counter-spin_more">Больше</span><span
                                            class="input-number__counter-spin input-number__counter-spin_less">Меньше</span>
        ...
        <li class="goods__item">
            <article class="good">
                <div class="good__content">
                    <a href="javascript:void(0);" class="good__link">
                        <img src="assets/images/good-5.jpg" alt="Товар" class="good__img" title=""><span
                                class="flag flag_type_hit">hit</span>
                    </a><a href="javascript:void(0);" class="like">Мне нравится</a>
                ...
                <div class="good__hover">
                    <form method="post" action="" class="form good__order">
                        <div class="good__order-row">
                            <label class="good__order-label">Выберите размер</label>
                            <div class="checkbox-tile">
                                <input id="good4-size0" name="Good[size]" type="radio" value="74" required
                                       class="checkbox-tile__elem">
                                <label for="good4-size0" class="checkbox-tile__label">74</label>
                            </div>
                            <div class="checkbox-tile">
                                <input id="good4-size1" name="Good[size]" type="radio" value="80" required
                                       class="checkbox-tile__elem">
                                <label for="good4-size1" class="checkbox-tile__label">80</label>
                            </div>
                            <div class="checkbox-tile">
                                <input id="good4-size2" name="Good[size]" type="radio" value="86" required
                                       class="checkbox-tile__elem">
                                <label for="good4-size2" class="checkbox-tile__label">86</label>
                            </div>
                            <div class="checkbox-tile">
                                <input id="good4-size3" name="Good[size]" type="radio" value="92" required
                                       class="checkbox-tile__elem">
                                <label for="good4-size3" class="checkbox-tile__label">92</label>
                            </div>
                            <div class="checkbox-tile">
                                <input id="good4-size4" name="Good[size]" type="radio" value="98" required
                                       class="checkbox-tile__elem">
                        ...
                        <div class="good__order-row">
                            ...
                            <div class="input-number">
                                <input id="good4-num" name="Good[number]" type="number" step="1" min="1" required
                                       class="input-number__elem">
                                <div class="input-number__counter"><span
                                            class="input-number__counter-spin input-number__counter-spin_more">Больше</span><span
                                            class="input-number__counter-spin input-number__counter-spin_less">Меньше</span>
...
<article class="product-page__section">
    <h2 class="heading product-page__title"><span class="heading__text">Рекомендуем</span></h2>
    <ul class="goods product-page__goods">
        <li class="goods__item">
            <article class="good">
                <div class="good__content">
                ...
                <div class="good__hover">
                    <form method="post" action="" class="form good__order">
                        <div class="good__order-row">
                            <label class="good__order-label">Выберите размер</label>
                            <div class="checkbox-tile">
                                <input id="good5-size0" name="Good[size]" type="radio" value="74" required
                                       class="checkbox-tile__elem">
                                <label for="good5-size0" class="checkbox-tile__label">74</label>
                            </div>
                            <div class="checkbox-tile">
                                <input id="good5-size1" name="Good[size]" type="radio" value="80" required
                                       class="checkbox-tile__elem">
                                <label for="good5-size1" class="checkbox-tile__label">80</label>
                            </div>
                            <div class="checkbox-tile">
                                <input id="good5-size2" name="Good[size]" type="radio" value="86" required
                                       class="checkbox-tile__elem">
                                <label for="good5-size2" class="checkbox-tile__label">86</label>
                            </div>
                            <div class="checkbox-tile">
                                <input id="good5-size3" name="Good[size]" type="radio" value="92" required
                                       class="checkbox-tile__elem">
                                <label for="good5-size3" class="checkbox-tile__label">92</label>
                            </div>
                            <div class="checkbox-tile">
                                <input id="good5-size4" name="Good[size]" type="radio" value="98" required
                                       class="checkbox-tile__elem">
                        ...
                        <div class="good__order-row">
                            ...
                            <div class="input-number">
                                <input id="good5-num" name="Good[number]" type="number" step="1" min="1" required
                                       class="input-number__elem">
                                <div class="input-number__counter"><span
                                            class="input-number__counter-spin input-number__counter-spin_more">Больше</span><span
                                            class="input-number__counter-spin input-number__counter-spin_less">Меньше</span>
                ...
                <div class="good__hover">
                    <form method="post" action="" class="form good__order">
                        <div class="good__order-row">
                            <label class="good__order-label">Выберите размер</label>
                            <div class="checkbox-tile">
                                <input id="good6-size0" name="Good[size]" type="radio" value="74" required
                                       class="checkbox-tile__elem">
                                <label for="good6-size0" class="checkbox-tile__label">74</label>
                            </div>
                            <div class="checkbox-tile">
                                <input id="good6-size1" name="Good[size]" type="radio" value="80" required
                                       class="checkbox-tile__elem">
                                <label for="good6-size1" class="checkbox-tile__label">80</label>
                            </div>
                            <div class="checkbox-tile">
                                <input id="good6-size2" name="Good[size]" type="radio" value="86" required disabled
                                       class="checkbox-tile__elem">
                                <label for="good6-size2" class="checkbox-tile__label">86</label>
                            </div>
                            <div class="checkbox-tile">
                                <input id="good6-size3" name="Good[size]" type="radio" value="92" required
                                       class="checkbox-tile__elem">
                                <label for="good6-size3" class="checkbox-tile__label">92</label>
                            </div>
                            <div class="checkbox-tile">
                                <input id="good6-size4" name="Good[size]" type="radio" value="98" required
                                       class="checkbox-tile__elem">
                        ...
                        <div class="good__order-row">
                            ...
                            <div class="input-number">
                                <input id="good6-num" name="Good[number]" type="number" step="1" min="1" required
                                       class="input-number__elem">
                                <div class="input-number__counter"><span
                                            class="input-number__counter-spin input-number__counter-spin_more">Больше</span><span
                                            class="input-number__counter-spin input-number__counter-spin_less">Меньше</span>
                ...
                <div class="good__hover">
                    <form method="post" action="" class="form good__order">
                        <div class="good__order-row">
                            <label class="good__order-label">Выберите размер</label>
                            <div class="checkbox-tile">
                                <input id="good7-size0" name="Good[size]" type="radio" value="74" required
                                       class="checkbox-tile__elem">
                                <label for="good7-size0" class="checkbox-tile__label">74</label>
                            </div>
                            <div class="checkbox-tile">
                                <input id="good7-size1" name="Good[size]" type="radio" value="80" required
                                       class="checkbox-tile__elem">
                                <label for="good7-size1" class="checkbox-tile__label">80</label>
                            </div>
                            <div class="checkbox-tile">
                                <input id="good7-size2" name="Good[size]" type="radio" value="86" required
                                       class="checkbox-tile__elem">
                                <label for="good7-size2" class="checkbox-tile__label">86</label>
                            </div>
                            <div class="checkbox-tile">
                                <input id="good7-size3" name="Good[size]" type="radio" value="92" required
                                       class="checkbox-tile__elem">
                                <label for="good7-size3" class="checkbox-tile__label">92</label>
                            </div>
                            <div class="checkbox-tile">
                                <input id="good7-size4" name="Good[size]" type="radio" value="98" required
                                       class="checkbox-tile__elem">
                        ...
                        <div class="good__order-row">
                            ...
                            <div class="input-number">
                                <input id="good7-num" name="Good[number]" type="number" step="1" min="1" required
                                       class="input-number__elem">
                                <div class="input-number__counter"><span
                                            class="input-number__counter-spin input-number__counter-spin_more">Больше</span><span
                                            class="input-number__counter-spin input-number__counter-spin_less">Меньше</span>
                ...
                <div class="good__hover">
                    <form method="post" action="" class="form good__order">
                        <div class="good__order-row">
                            <label class="good__order-label">Выберите размер</label>
                            <div class="checkbox-tile">
                                <input id="good8-size0" name="Good[size]" type="radio" value="74" required
                                       class="checkbox-tile__elem">
                                <label for="good8-size0" class="checkbox-tile__label">74</label>
                            </div>
                            <div class="checkbox-tile">
                                <input id="good8-size1" name="Good[size]" type="radio" value="80" required
                                       class="checkbox-tile__elem">
                                <label for="good8-size1" class="checkbox-tile__label">80</label>
                            </div>
                            <div class="checkbox-tile">
                                <input id="good8-size2" name="Good[size]" type="radio" value="86" required
                                       class="checkbox-tile__elem">
                                <label for="good8-size2" class="checkbox-tile__label">86</label>
                            </div>
                            <div class="checkbox-tile">
                                <input id="good8-size3" name="Good[size]" type="radio" value="92" required
                                       class="checkbox-tile__elem">
                                <label for="good8-size3" class="checkbox-tile__label">92</label>
                            </div>
                            <div class="checkbox-tile">
                                <input id="good8-size4" name="Good[size]" type="radio" value="98" required
                                       class="checkbox-tile__elem">
                        ...
                        <div class="good__order-row">
                            ...
                            <div class="input-number">
                                <input id="good8-num" name="Good[number]" type="number" step="1" min="1" required
                                       class="input-number__elem">
                                <div class="input-number__counter"><span
                                            class="input-number__counter-spin input-number__counter-spin_more">Больше</span><span
                                            class="input-number__counter-spin input-number__counter-spin_less">Меньше</span>
...
<div data-popup="good" class="popup">
    <div class="popup-good popup__content">
        <div class="popup-good__title">Товар добавлен в корзину</div>
        <img src="assets/images/popup-1.jpg" alt="Фото товара" class="popup-good__img" title="">
        <p class="popup-good__desc text">Шапка-бини для новорожденных Nokoset</p>
        <div class="popup-good__row"><a href="javascript:void(0);"
                                        class="btn btn_border js-popup-close popup-good__btn">Вернуться в
                каталог</a><a
                    href="javascript:void(0);" class="btn popup-good__btn">Оформить заказ</a>
        </div>
    </div>
</div>
</div>
