    ...
    <div class="container footer__container">
        <div class="footer__col">
            <h3 class="footer__title"> <? $APPLICATION->IncludeComponent(
                    ...
                    array(
                        "AREA_FILE_SHOW" => "file",
                        "PATH" => SITE_DIR . "/local/templates/my_lassie_shop/include_areas/footer__title_1.php"
                    ),
                    false
                ); ?></h3>
<!--            <ul class="list">-->
...
<!--            </ul>-->
        ...
        <div class="footer__col">
            <h3 class="footer__title"><? $APPLICATION->IncludeComponent(
                    ...
                    array(
                        "AREA_FILE_SHOW" => "file",
                        "PATH" => SITE_DIR . "/local/templates/my_lassie_shop/include_areas/footer__title_2.php"
                    ),
                    false
                ); ?></h3>
<!--            <ul class="list">-->
...
<!--            </ul>-->
        ...
        <div class="footer__col">
            <h3 class="footer__title"><? $APPLICATION->IncludeComponent(
                    ...
                    array(
                        "AREA_FILE_SHOW" => "file",
                        "PATH" => SITE_DIR . "/local/templates/my_lassie_shop/include_areas/footer__title_3.php"
                    ),
                    false
                ); ?></h3>
<!--            <ul class="list">-->
...
<!--            </ul>-->
        ...
        <div class="footer__col">
            <h3 class="footer__title"><? $APPLICATION->IncludeComponent(
                    ...
                    array(
                        "AREA_FILE_SHOW" => "file",
                        "PATH" => SITE_DIR . "/local/templates/my_lassie_shop/include_areas/footer__title_4.php"
                    ),
                    false
                ); ?></h3>
